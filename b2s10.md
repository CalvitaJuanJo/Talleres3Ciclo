...
val suma: Signal[Int] = calificaciones.map(lista => lista.sum)
calificaciones.set(calificaciones.now :+ 10)
suma.observe(s => println(s"Suma Total = $s"))
calificaciones.set(calificaciones.now :+ 20)
Thread.sleep(2000)
}
```
<img width="1919" height="1023" alt="image" src="https://github.com/user-attachments/assets/969a9443-6dee-48de-a814-bf6258cdc1ba" />
...
package TallerB2s10
import rescala.default._
object TallerB2S102 extends App{
...
val energiaCinetica = Signal {0.5 * masa.value * math.pow(velocidad.value, 2)}
  ...
  val observer = energiaCinetica.observe { valor =>
    ...
    if (valor > 1000000) println("Alerta: Energía cinética muy alta, reduzca la velocidad.")
...
```
<img width="1919" height="1015" alt="image" src="https://github.com/user-attachments/assets/7ad5a12a-658e-4810-bde3-cafb99d02e33" />
